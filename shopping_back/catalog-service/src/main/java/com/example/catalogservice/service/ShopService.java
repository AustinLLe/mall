...
import com.example.catalogservice.dto.ShopDtos.KeyValue;
...
import com.example.catalogservice.dto.ShopDtos.ReviewView;
...
import com.example.catalogservice.dto.ShopDtos.TimelineNode;
import com.example.catalogservice.mapper.ShopProductMapper;
import com.example.catalogservice.mapper.ShopStoreMapper;
...
public class ShopService {
    ...
    private List<ReviewView> reviewsForGoods(Integer goodsId) {
        ...
        try {
            productMapper.createReviewTable();
            return productMapper.selectProductReviews(goodsId).stream()
